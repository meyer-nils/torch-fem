...
All examples are Jupyter notebooks from the [examples directory](https://github.com/meyer-nils/torch-fem/tree/main/examples) rendered to HTML. Each notebook contains badges to run it interactively on Binder or Google Colab.
